...
public class VehiculoController {
    ...
    public ResponseEntity<Vehiculo> obtenerPorPatente(@PathVariable String patente){
        try {
            Vehiculo vehiculo = service.buscarPorPatente(patente);
            return ResponseEntity.ok(vehiculo);
        } catch (Exception e) {
            return ResponseEntity.notFound().build();
        }
...
////////////////////////////////
    ...
    public ResponseEntity<TipoVehiculo> obtenerTipoPorNombre(@PathVariable String nombre){
        try {
            TipoVehiculo tipoVehiculo = service.buscarTipoPorNombre(nombre);
    ...
    public ResponseEntity<MarcaVehiculo> obtenerMarcaPorNombre(@PathVariable String nombre){
        try {
            MarcaVehiculo marcaVehiculo = service.buscarMarcaPorNombre(nombre);
            return ResponseEntity.ok(marcaVehiculo);
        } catch (Exception e) {
            return ResponseEntity.notFound().build();
        }
    }
